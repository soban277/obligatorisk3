...
Har lagt til application properties, schema.sql, billett.repository og endret js. Endret også på controller for å få det til å BilletterRepository til å funke. 
